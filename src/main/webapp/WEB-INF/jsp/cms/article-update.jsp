	    ...
	    <div class="ibox-content no-padding">
		  	<form id="articleForm" class="form-horizontal form" style="margin-top: 10px;">
			   <div class="form-group">
			      ...
			      <div class="col-sm-8">
			         <div>
			         	<input type="text" class="form-control" id="title" name="title" value="${article.title}" maxlength="20" placeholder="请输入标题">
			         </div>
			      </div>
			   </div>
			   <div class="form-group">
			      ...
			      <div class="col-sm-8">
			         <div>
			         	<textarea class="form-control" id="lead" name="lead" placeholder="请输入描述">${article.lead}</textarea>
			         </div>
			      </div>
			   </div>
			   <div class="form-group">
